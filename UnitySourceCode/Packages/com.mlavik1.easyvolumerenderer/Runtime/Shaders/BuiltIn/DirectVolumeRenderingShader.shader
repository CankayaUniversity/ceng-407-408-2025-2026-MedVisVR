Shader "VolumeRendering/Builtin/VolumeRendering"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        {
            CGPROGRAM
            // --- Quest 3 optimizasyonu: kullanilmayan varyantlar shader_feature_local ile build'den cikarildi ---
            #pragma multi_compile MODE_DVR MODE_MIP MODE_SURF
            #pragma shader_feature_local __ TF2D_ON
            #pragma multi_compile __ CROSS_SECTION_ON
            #pragma multi_compile __ LIGHTING_ON
            #pragma shader_feature_local __ SHADOWS_ON
            ...
            #pragma shader_feature_local __ CUBIC_INTERPOLATION_ON
            #pragma shader_feature_local __ SECONDARY_VOLUME_ON
            #pragma shader_feature_local MULTIVOLUME_NONE MULTIVOLUME_OVERLAY MULTIVOLUME_ISOLATE
