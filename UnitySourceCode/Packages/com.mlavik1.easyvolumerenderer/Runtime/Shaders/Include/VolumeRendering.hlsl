...
{
    // Quest 3: 512 -> 384, samplingRate*0.55 ile ~211 etkin adim. Termal throttle ve
    // multiview compositor judder'i bu degerle stabil hale geldi.
    #define MAX_NUM_STEPS 384
